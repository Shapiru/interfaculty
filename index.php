...
if(isset($_POST['submit'])){
    ...
    $select_query=mysqli_query($conn,"SELECT * FROM admin WHERE name='$name' AND password='$password'")
...
<body class="animsition">
    <div class="page-wrapper">
                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="faculties.html">
                                <i class="far fa-check-square"></i>Faculties</a>
                        </li>
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="#">
                    <h3>Interfaculty Transfer System</h3>
                </a>
            </div>
